...
mod tests {
    ...
    test_request! {
        ...
        } => const_format::concatcp!("fe534d4240000100010000000100210010000000000000000200000000000000fffe000000000000390000000034000000000000000000000000000000000000190000010100000000000000580059000000000000000000", SETUP_REQUEST_DATA)
    }
