...
mod tests {
    ...
    test_request! {
        ...
        } => const_format::concatcp!("fe534d4240000100000000000b0001001800000000000000a904000000000000fffe000005000000390000440384000033d8e02b320cb7198f8d90d2d6751dc23900000017c01100280500000c000000850000000c0000007800000098000000000000000000000000000000000400000100000000000000", REQ_IOCTL_BUFFER_CONTENT)
    }
    ...
    test_response! {
        ...
        } => const_format::concatcp!("fe534d4240000100000000000b0001003100000000000000a600000000000000fffe0000050000003100002800300000000000000000000000000000000000003100000017c01100280500000c000000850000000c000000700000000000000070000000040100000000000000000000",IOCTL_TEST_BUFFER_CONTENT)
    }
}
